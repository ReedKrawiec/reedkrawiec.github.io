    ...
    content: (
      <div className="fullpage">
        ...
        <div className="lander__about">
          <h1>About me</h1>
          <p>I'm a Sophomore Computer Science student at Rutgers University. I enjoy tinkering with new, interesting and innovative technologies and disciplines within CS. My freetime is most enjoyed when it's spent doing an interesting personal project, or playing my guitar. Right now my interests are in Web Design and Development, App development, Machine Learning and Systems Programming.</p>
          <h1>Skills</h1>
